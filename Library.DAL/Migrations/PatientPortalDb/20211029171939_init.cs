    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PracticeRoom", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalFile_Employee_IntakeSupervisionId",
                        column: x => x.IntakeSupervisionId,
                        principalTable: "Employee",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MedicalFile_Employee_IntakeTherapistIdId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_MedicalFile_MedicalFileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Note_MedicalFile_MedicalFileId",
                        column: x => x.MedicalFileId,
                        principalTable: "MedicalFile",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TreatmentPlan_PracticeRoom_PracticeRoomId",
                        column: x => x.PracticeRoomId,
                        principalTable: "PracticeRoom",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TreatmentPlan_Employee_TreatmentPerformedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_MedicalFileId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalFile_IntakeSupervisionId",
                table: "MedicalFile",
                column: "IntakeSupervisionId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalFile_IntakeTherapistIdId",
                table: "MedicalFile",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TreatmentPlan_PracticeRoomId",
                table: "TreatmentPlan",
                column: "PracticeRoomId");

            migrationBuilder.CreateIndex(
                name: "IX_TreatmentPlan_TreatmentPerformedById",
                table: "TreatmentPlan",
